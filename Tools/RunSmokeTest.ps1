...
Write-Host 'Runtime smoke test passed: charged-range outbound, multi-target return-path recovery, inventory, multi-floor raft generation, passive facility production, facility storage, and versioned save/load.'
