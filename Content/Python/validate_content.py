...
REQUIRED_ASSETS = [
    ...
    *[f"/Game/Driftstead/Materials/{name}" for name in ("M_Water","M_WoodLight","M_WoodDark","M_Metal","M_Rope","M_Cloth","M_Crop","M_InteractionHighlight","M_RareItem","M_TransparentFloor")],
